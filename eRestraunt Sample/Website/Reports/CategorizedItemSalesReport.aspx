...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="ItemSalesDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="TotalCategorizedItemSales" TypeName="eRestraunt.BLL.ReportsController"></asp:ObjectDataSource>
</asp:Content>