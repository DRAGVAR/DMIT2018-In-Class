        ...
        <div class="pull-right col-md-5">
            <details open>
                ...
                <asp:Repeater ID="ReservationsRepeater" runat="server"
                    ItemType="eRestraunt.Entities.DTOs.ReservationCollection" DataSourceID="ReservationsDataSource">
                    <ItemTemplate>
                        <div>
        ...
        <div class="col-md-7">
            <details open>
                ...
                <asp:GridView ID="SeatingGridView" runat="server"
                    ...
                    ItemType="eRestraunt.Entities.DTOs.SeatingSummary" AutoGenerateColumns="False" DataSourceID="SeatingDataSource">
                    <Columns>
                ...
                <asp:ObjectDataSource runat="server" ID="SeatingDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="SeatingByDateTime" TypeName="eRestraunt.BLL.SeatingController">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="SearchDate" PropertyName="Text" Name="date" Type="DateTime"></asp:ControlParameter>
