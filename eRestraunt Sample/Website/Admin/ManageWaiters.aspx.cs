...
public partial class Admin_ManageWaiters : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            // TODO: List the waiters in the dropdown list: MessageUserControl.ShowInfo("This form allows you to edit information on new and existing waiters.");
        }
    }
    ...
    public void AddWaiter()
    {
        ...
        var controller = new RestrauntAdminController();
        person.WaiterID = controller.AddWaiter(person);
        WaiterID.Text = person.WaiterID.ToString();
        // TODO: Re-populate dropdownlist of waiters. And set the selected value as well.
    }
